...
if not st.session_state.get("dataset_loaded", False):
    ...
    results_exist = check_results_exist("ft:gpt-3.5-turbo-0125:personal:classifier-model:9jq8ioDW", "fine_zero_shot", 0.0, "automated")
    ...
    results_exist = check_results_exist("ft:gpt-3.5-turbo-0125:personal:classifier-model:9jq8ioDW", "fine_no_prompting", 0.0, "automated")
