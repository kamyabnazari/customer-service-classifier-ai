        ...
        for _, row in samples.iterrows():
            ...
            if method_option == "Zero-Shot":
                if model_option == "GPT-3.5 Turbo":
                    classification = classify_with_gpt_3_5_turbo_zero_shot(text, global_state.datasets["categories"])
                elif model_option == "GPT-3.5 Turbo Fine-Tuned":
                    classification = classify_with_gpt_3_5_turbo_fine_zero_shot(text, global_state.datasets["categories"])
                elif model_option == "GPT-4o":
                    classification = classify_with_gpt_4o_zero_shot(text, global_state.datasets["categories"])
            elif method_option == "Few-Shot":
                if model_option == "GPT-3.5 Turbo":
                    classification = classify_with_gpt_3_5_turbo_few_shot(text, global_state.datasets["categories"])
                elif model_option == "GPT-3.5 Turbo Fine-Tuned":
                    classification = classify_with_gpt_3_5_turbo_fine_few_shot(text, global_state.datasets["categories"])
                elif model_option == "GPT-4o":
                    classification = classify_with_gpt_4o_few_shot(text, global_state.datasets["categories"])
