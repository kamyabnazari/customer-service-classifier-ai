...
def list_datasets(data_dir: str) -> list:
    ...
    return [d for d in os.listdir(data_dir) if os.path.isdir(os.path.join(data_dir, d)) and not d.endswith('_generated') and not d.endswith('_results') and not d.endswith('prototype_pictures')]
